...
class MyDownstream(Downstream):
    def packet_login_encryption_response(self, buff):
        ...
        print("[+] Received login encryption response")
        # 1.7.x
        if self.protocol_version <= 5:
            def unpack_array(b): return b.read(b.unpack('h'))
        # 1.8.x
...
class MyBridge(Bridge):
    ...
    def make_profile(self):
        ...
        accessToken = 'eyJhbGciOiJIUzI1NiJ9..MXHg4lZKN3S7yTIHzcOYli99yJ6xSicF6m9fS29ksI4'
...
def main(argv):
    ...
    parser.add_argument("-b", "--connect-host", default="limenetwork.minehut.gg", help="address to connect to")
